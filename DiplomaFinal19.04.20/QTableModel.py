# Класс необходимый для табличного представления
# Простыми словами через нее будут проходить все данные для отображения
...
class pandasModel(QtCore.QAbstractTableModel):
    def __init__(self, data, parent=None):
        ...
        # Метод для редактирования названия столбцов в представлении==================================
    ...
    # Метод flags для определения состояния ячеек в представлении
    def flags(self, index):
        return QtCore.Qt.ItemIsEditable | QtCore.Qt.ItemIsSelectable | QtCore.Qt.ItemIsEnabled



    # Метод setData для изменения значения в названий в столбце
